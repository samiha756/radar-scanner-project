...
Angle + distance pairs are streamed over serial to a Processing sketch, which renders a live radar-style sweep with a highlighted "ping" for detected objects. 
...
processing/
 radar_display.pde     
 Processing visualization sketch
 README.md
